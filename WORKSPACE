...
maven_install(
    ...
    artifacts = [
        ...
        "com.fasterxml.jackson.jaxrs:jackson-jaxrs-yaml-provider:2.10.5",
        ...
        "com.fasterxml.jackson.module:jackson-module-jsonSchema:2.10.5",
        ...
        "de.bwaldvogel:mongo-java-xxxxxxxx1.34.0",
