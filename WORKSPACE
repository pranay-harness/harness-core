...
plain_artifacts = [
    ...
    "org.glassfish.jersey.containers:jersey-container-servlet-core:2.33",
    "org.glassfish.jersey.containers:jersey-container-servlet:2.33",
    "org.glassfish.jersey.core:jersey-client:2.33",
    "org.glassfish.jersey.core:jersey-common:2.33",
    "org.glassfish.jersey.core:jersey-xxxxxxxx2.33",
...
maven_install(
    ...
    artifacts = plain_artifacts + amazon_artifacts + powermock_artifacts + [
        ...
        maven_test_artifact("org.glassfish.jersey.test-framework.providers:jersey-test-framework-provider-grizzly2:2.33"),
        maven_test_artifact("org.glassfish.jersey.test-framework.providers:jersey-test-framework-provider-inmemory:2.33"),
        maven_test_artifact("org.glassfish.jersey.test-framework:jersey-test-framework-core:2.33"),
